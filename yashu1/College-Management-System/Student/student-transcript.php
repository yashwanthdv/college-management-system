...
<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            ...
            <h4 class="text-dark mt-3">KNS INSTITUTE OF TECHNOLOGY</h4>
            <h4 class="text-dark">Knowledge is power</h4>
        </div>
    </div>
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                ?>
                                    <th colspan="2"><div class="d-flex"><span class="mr-5">Semester - 1</span><span class="ml-5"><?php echo  " "; ?> </span></div></th>
                                    <th>CH</th>
                                    <th>%</th>
                                    <th>G.P</th>
                                    <th>Letter</th>
