...
<html>
<head>
	<title>Home-KNS institute of technology</title>
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="images/logo.jpeg" class="logo.jpeg" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">KNS INSTITUTE OF TECHNOLOGY</h3>
	</a>
