	...
	<div class="container-fluid">
			...
			<div class="col-md-12">
				<form action="student.php" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleInputEmail1">tenth Complition Date: </label>
								<input type="date" name="tenth_complition_date" class="form-control">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleInputPassword1">tenth Awarded Date:</label>
								<input type="date" name="tenth_awarded_date" class="form-control">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleInputPassword1">Upload tenth Certificate:</label>
								<input type="file" name="tenth_certificate" class="form-control" value="there is no image">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleInputEmail1">puc Complition Date: </label>
								<input type="date" name="puc_complition_date" class="form-control">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleInputPassword1">puc Awarded Date:</label>
								<input type="date" name="puc_awarded_date" class="form-control">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleInputPassword1">Upload puc Certificate:</label>
								<input type="file" name="puc_certificate" class="form-control" value="there is no image" >
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="date" name="BE_complition_date" class="form-control" value="0">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleInputPassword1">BE Awarded Date:</label>
								<input type="date" name="BE_awarded_date" class="form-control">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="exampleInputPassword1">Upload BE Certificate:</label>
								<input type="file" value="C:/xampp/htdocs/yashu1/Images/no-image-available.jpg" name="BE_certificate" class="form-control" >
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-12 w-100 p-5">
				...
				<p class="tet-justify">
					      I solemnly declare that I have submitted the application with the consent of my father / guardian. I pledge to abide by the Rules and Regulations of the KNSIT and shall not take part in political activities of any kind. If I do so the KNSIT Administration will have the right to strike my name off the KNSIT Rolls. I pledge that I will not keep in my possession weapons of any kind whether licensed or unlicensed. I affirm that I was never expelled / rusticated by any Institution at any time. I understand that if my class attendance percentage is not up to the required standard of the KNSIT, I will not be eligible to sit in the final examinations. I affirm that if at any stage the documents submitted by me for admission are proved forged, fake, or erroneous I shall be responsible for that and the KNSIT Administration shall be rightful to cancel my admission and to take necessary action against me.
				</p>
			</div>
		</div>	
	</div>
