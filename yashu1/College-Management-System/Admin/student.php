...
<?php  
 	if (isset($_POST['btn_save'])) {
		...
		$permanent_address=$_POST["permanent_address"];
 		...
 		$tenth_complition_date=$_POST["tenth_complition_date"];
 		
 		$tenth_awarded_date=$_POST["tenth_awarded_date"];
 		
 		$puc_complition_date=$_POST["puc_complition_date"];
 		
 		$puc_awarded_date=$_POST["puc_awarded_date"];
...
// *****************************************Images upload code starts here********************************************************** 
		...
		$tenth_certificate = $_FILES['tenth_certificate']['name'];$tmp_name=$_FILES['tenth_certificate']['tmp_name'];$path = "images/".$tenth_certificate;move_uploaded_file($tmp_name, $path);

		$puc_certificate = $_FILES['puc_certificate']['name'];$tmp_name=$_FILES['puc_certificate']['tmp_name'];$path = "images/".$puc_certificate;move_uploaded_file($tmp_name, $path);


// *****************************************Images upload code end here********************************************************** 

 		$query="Insert into student_info(roll_no,first_name,middle_name,last_name,father_name,email,mobile_no,course_code,session,profile_image,prospectus_issued,prospectus_amount,form_b,applicant_status,application_status,cnic,dob,gender,permanent_address,current_address,place_of_birth,tenth_complition_date,tenth_awarded_date,tenth_certificate,puc_complition_date,puc_awarded_date,puc_certificate)values('$roll_no','$first_name','$middle_name','$last_name','$father_name','$email','$mobile_no','$course_code','$session','$profile_image','$prospectus_issued','$prospectus_amount','$form_b','$applicant_status','$application_status','$cnic','$dob','$gender','$permanent_address','$current_address','$place_of_birth','$tenth_complition_date','$tenth_awarded_date','$tenth_certificate','$puc_complition_date','$puc_awarded_date','$puc_certificate')";
							        ...
							        <form action="student.php" method="POST" enctype="multipart/form-data">
										<div class="row mt-3">
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">tenth Certificate:</label>
